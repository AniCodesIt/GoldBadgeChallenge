...
namespace KomodoClaimsRepo
{
    ...
    public class ClaimContent
    {
        ...
        public ClaimContent(string claimID, ClaimType claimType, string description, decimal claimAmount, DateTime dateOfIncident, DateTime dateOfClaim, bool isValid)
        {
